...
defmodule CompareSubset7AControlPacketJson do
  ...
  def main(argv) do
    ...
    {report, blockers, _warnings} =
      CompareResultSets.compare_paths!(fx_path, expected_path,
        title: "Subset 7A FX vs Expected Control Packet Compatibility Comparison",
        ...
        success_verdict: "- verdict: no blocking mismatches found in the shared control-packet compatibility surface",
        failure_verdict:
          "- verdict: blocking mismatches found; do not treat FX as semantically aligned for the affected control-packet rows"
      )
...
CompareSubset7AControlPacketJson.main(System.argv())
