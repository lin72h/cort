...
defmodule CompareSubset7EControlNotifyJson do
  ...
  def main(argv) do
    ...
    {report, blockers, _warnings} =
      CompareResultSets.compare_paths!(fx_path, expected_path,
        title: "Subset 7E FX vs Expected Notify Client Outcome Compatibility Comparison",
        ...
        success_verdict: "- verdict: no blocking mismatches found in the shared notify-client outcome compatibility surface",
        failure_verdict:
          "- verdict: blocking mismatches found; do not treat FX as semantically aligned for the affected notify-client outcome rows"
      )
...
CompareSubset7EControlNotifyJson.main(System.argv())
