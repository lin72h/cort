...
defmodule CompareSubset7DControlResponseJson do
  ...
  def main(argv) do
    ...
    {report, blockers, _warnings} =
      CompareResultSets.compare_paths!(fx_path, expected_path,
        title: "Subset 7D FX vs Expected Control Response Profile Compatibility Comparison",
        ...
        success_verdict: "- verdict: no blocking mismatches found in the shared control-response-profile compatibility surface",
        failure_verdict:
          "- verdict: blocking mismatches found; do not treat FX as semantically aligned for the affected control-response-profile rows"
      )
...
CompareSubset7DControlResponseJson.main(System.argv())
