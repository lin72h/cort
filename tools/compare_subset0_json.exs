  ...
  def main(argv) do
    ...
    {report, blockers, _warnings} =
      CompareResultSets.compare_paths!(fx_path, mx_path,
        title: "Subset 0 FX vs MX Comparison",
        ...
        success_verdict: "- verdict: no blocking mismatches found in the shared comparison surface",
        failure_verdict: "- verdict: blocking mismatches found; do not treat FX as semantically aligned for the affected required rows"
      )
