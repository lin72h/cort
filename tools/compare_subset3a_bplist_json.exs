...
defmodule CompareSubset3ABplistJson do
  ...
  @diagnostic_fields ["type_id", "type_description"]
  ...
  def main(argv) do
    ...
    {report, blockers, _warnings} =
      CompareResultSets.compare_paths!(fx_path, mx_path,
        title: "Subset 3A FX vs MX Binary Plist Core Comparison",
        ...
        success_verdict: "- verdict: no blocking mismatches found in the shared binary-plist core comparison surface",
        failure_verdict:
          "- verdict: blocking mismatches found; do not treat FX as semantically aligned for the affected required binary-plist rows"
      )
...
CompareSubset3ABplistJson.main(System.argv())
