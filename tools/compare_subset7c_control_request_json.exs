...
defmodule CompareSubset7CControlRequestJson do
  ...
  def main(argv) do
    ...
    {report, blockers, _warnings} =
      CompareResultSets.compare_paths!(fx_path, expected_path,
        title: "Subset 7C FX vs Expected Control Request Route Compatibility Comparison",
        ...
        success_verdict: "- verdict: no blocking mismatches found in the shared control-request-route compatibility surface",
        failure_verdict:
          "- verdict: blocking mismatches found; do not treat FX as semantically aligned for the affected control-request-route rows"
      )
...
CompareSubset7CControlRequestJson.main(System.argv())
