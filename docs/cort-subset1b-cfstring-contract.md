...
Status: MX validation is clean on the tightened 1B surface; compare workflow is
packaged; bounded FX implementation exists locally.
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1B | ASCII `CFStringCreateWithCString` roundtrip | `../wip-cort-gpt-artifacts/cort-mx/runs/subset1b-mx-cfstring-core/out/subset1b_cfstring_core.json` | Not implemented | `unknown` | type/hash numerics diagnostic | `cfstring_ascii_cstring_roundtrip` | MX run clean; FX compare pending |
| 1B | zero-length string creation and roundtrip across tested creation APIs | `../wip-cort-gpt-artifacts/cort-mx/runs/subset1b-mx-cfstring-core/out/subset1b_cfstring_core.json` | Not implemented | `unknown` | type/hash numerics diagnostic | `cfstring_empty_roundtrip` | MX run clean; FX compare pending |
| 1B | UTF-8 `CFStringCreateWithCString` roundtrip | `../wip-cort-gpt-artifacts/cort-mx/runs/subset1b-mx-cfstring-core/out/subset1b_cfstring_core.json` | Not implemented | `unknown` | type/hash numerics diagnostic | `cfstring_utf8_cstring_roundtrip` | MX run clean; FX compare pending |
| 1B | ASCII `CFStringCreateWithBytes` plus ASCII `CFStringGetBytes` full-range extraction | `../wip-cort-gpt-artifacts/cort-mx/runs/subset1b-mx-cfstring-core/out/subset1b_cfstring_core.json` | Not implemented | `unknown` | type/hash numerics diagnostic | `cfstring_bytes_ascii_roundtrip` | MX run clean; FX compare pending |
| 1B | UTF-16 `CFStringCreateWithCharacters` roundtrip | `../wip-cort-gpt-artifacts/cort-mx/runs/subset1b-mx-cfstring-core/out/subset1b_cfstring_core.json` | Not implemented | `unknown` | type/hash numerics diagnostic | `cfstring_utf16_characters_roundtrip` | MX run clean; FX compare pending |
| 1B | `CFStringCreateCopy` ownership, equality, and hash coherence | `../wip-cort-gpt-artifacts/cort-mx/runs/subset1b-mx-cfstring-core/out/subset1b_cfstring_core.json` | Not implemented | `unknown` | copy pointer identity diagnostic only | `cfstring_copy_equality_hash` | MX run clean; FX compare pending |
| 1B | `CFStringGetCString` exact-fit success and buffer-too-small failure | `../wip-cort-gpt-artifacts/cort-mx/runs/subset1b-mx-cfstring-core/out/subset1b_cfstring_core.json` | Not implemented | `unknown` | buffer contents outside success contract | `cfstring_getcstring_small_buffer` | MX run clean; FX compare pending |
| 1B | malformed UTF-8 rejection via `CFStringCreateWithBytes` | `../wip-cort-gpt-artifacts/cort-mx/runs/subset1b-mx-cfstring-core/out/subset1b_cfstring_core.json` | Not implemented | `unknown` | error wording not relevant | `cfstring_bytes_invalid_utf8_rejected` | MX run clean; FX compare pending |
| 1B | malformed UTF-8 rejection via `CFStringCreateWithCString` | `../wip-cort-gpt-artifacts/cort-mx/runs/subset1b-mx-cfstring-core/out/subset1b_cfstring_core.json` | Not implemented | `unknown` | error wording not relevant | `cfstring_cstring_invalid_utf8_rejected` | MX run clean; FX compare pending |
...
- `summary.md`
- `out/subset1b_cfstring_fx_vs_mx_report.md`
- `out/subset1b_cfstring_fx.json`
- `out/subset1b_cfstring_mx.json`
...
Preferred coordination command once FX publishes `subset1b_cfstring_fx.json`:
